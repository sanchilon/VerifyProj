  ...
  (props, forwardedRef) => {
    ...
    return (
      <>
        ...
        <SubtitleText>
          Open Verify provides a quick, easy and secure way to scan and
          confirm that a visitor’s enhanced vaccine certificate with official QR
          code meets the Ontario requirements for entry.
        </SubtitleText>
        <SubtitleText>
          <B>
